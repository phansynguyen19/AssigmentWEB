<%-- 
    Document   : login1
    Created on : Apr 13, 2021, 11:24:17 PM
    Author     : Admin
--%>
			...
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form action="DispatchController" method="POST">
				 	...
				 	<button type="submit" value="Login" name="btAction" class="btn login_btn">Login</button>
				   </div>
					</form>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="createNewAccount.jsp" class="ml-2">Sign Up</a>
					</div>
				</div>
			</div>
		</div>
